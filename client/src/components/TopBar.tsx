    ...
    <div className="bg-white border-b border-gray-100 text-sm hidden md:block">
      <div className="container flex items-center justify-between py-2">
        <div className="flex items-center gap-6">
          ...
          <a href={`mailto:${EMAIL}`} className="flex items-center gap-1.5 text-gray-600 hover:text-red-600 transition-colors">
            <Mail className="w-3.5 h-3.5" />
            <span>{EMAIL}</span>
          </a>
        </div>
        <div className="flex items-center gap-4">
          <span className="text-gray-500">Grupo CAP Honduras</span>
